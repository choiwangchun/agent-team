...
BENCH_JSON="${BENCH_JSON:-/tmp/saas-dashboard-autocannon.json}"
METRICS_JSON="${METRICS_JSON:-/tmp/saas-dashboard-ops-metrics.json}"
SERVER_LOG="${SERVER_LOG:-/tmp/saas-dashboard-server.log}"
SERVER_PID=""
